...
<div class="dropdown-content">
    ...
    <a href="message.php">Global chat</a>
...
$query1="SELECT * FROM user";
        ...
        {   ?>  
            <form method="post" attribute="post" action="message.php">
...
$query1="SELECT * FROM pchat WHERE( (myid=$myid) and (id=$id) or (myid=$id) and (id=$myid))";
        $result = mysqli_query($connection,$query1);
        if (!$result) echo "INSERT failed: $query<br>" .      $connection->error . "<br><br>";
        else
        {   
            ...
            {  if($row[1]== $myid )
               ...
               <div class="answer right">
                <div class="avatar">
                  <img src="images/<?php echo $myid  ?>.jpeg" alt="User name">
              ...
              <div class="avatar">
                  <img src="images/<?php echo  $id  ?>.jpeg" alt="User name">
                  <div class="status offline"></div>
                </div>
