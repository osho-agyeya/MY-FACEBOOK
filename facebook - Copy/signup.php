...
if (isset($_POST['submit'])) 
{
    ...
    $error_in_name=valid_name($name); 
    $error_in_password=valid_password($password)  ;
    ...
    $check=validation($error_in_name,$error_in_password,$error_in_password1,$error_in_number,$error_in_email,$error_in_email1,$error_in_dob);
  ...
  <body>
    ...
    <div class="body"></div>
		...
		<div class="login">
			...
			<span><select aria-label="Day" name="dob_day" id="day" title="Day">
